        ...
        <section className="w-full rounded-[2rem] border border-white/80 bg-white/90 p-6 shadow-[0_24px_80px_rgba(21,44,20,0.12)] backdrop-blur-xl sm:p-10">
          ...
          <div className="mt-6 flex items-center gap-3">
            ...
            <div>
              ...
              <h1 className="mt-1 font-serif text-3xl text-[#163117]">Set a new password</h1>
            </div>
          </div>

          <p className="mt-4 max-w-xl text-sm leading-6 text-[#4e594b] sm:text-base">
            Choose a strong password with mixed case, numbers, and symbols. The token expires
          ...
          <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
            ...
            <label className="block">
              <span className="mb-2 block text-sm font-medium text-[#364233]">New password</span>
              <input
                type="password"
                value={password}
                onChange={(event) => setPassword(event.target.value)}
                className="w-full rounded-2xl border border-[#d8dfd0] bg-white px-4 py-3.5 text-sm outline-none transition placeholder:text-[#98a596] focus:border-[#154212] focus:ring-4 focus:ring-[#154212]/10"
            ...
            <button
              type="submit"
              disabled={loadingCsrf || submitting}
